...
def on_open(ws):
    ...
    ws.send(json.dumps({
        "method": "SUBSCRIBE",
        "params": [
            "btcusdt@kline_1m",      # Kline/Candlestick Streams cho BTCUSDT với interval là 1 phút python extract/source_websocket.py
            "ethusdt@kline_1m",
            "adausdt@kline_1m",
            "bnbusdt@kline_1m",
            "solusdt@kline_1m",
...
if __name__ == "__main__":
    ...
    producer_candle = producer.kafkaProducer(config.TOPIC_CANDLE)
